        ...
        <div class="collapse navbar-collapse">
            ...
            <div class="lang_area">
                <form name="langForm" method="POST" action="controller">
                    ...
                    <input type="submit" name="english" class="headerButton" value="<fmt:message key="label.en_lang" bundle="${ rb }" />"/>
                    <input type="submit" name="russian" class="headerButton" value="<fmt:message key="label.ru_lang" bundle="${ rb }" />"/>
                </form>
            </div>
            <div class="lang_area">
                <form name="searchForm" method="POST" action="controller">
                    ...
                    <input type="submit"  class="headerButton" style="margin-right: 30px" value="<fmt:message key="label.search" bundle="${ rb }" />"/>
                </form>
            </div>
        </div>
    </div>
