...
public class JspPathName {
    ...
    public static final String PATH_TO_MAIN_JSP = "/jsp/main.jsp";
    public static final String PATH_TO_REGISTRATION_JSP = "/jsp/registration.jsp";
    public static final String PATH_TO_DRUGLIST_JSP = "/jsp/drugsList.jsp";
    public static final String PATH_TO_DRUGADD_JSP = "/jsp/addDrug.jsp";
    public static final String PATH_TO_DRUGDELETE_JSP = "/jsp/deleteDrug.jsp";
    public static final String PATH_TO_MODDRUG_JSP = "/jsp/modDrug.jsp";
    public static final String PATH_TO_BASKET_JSP = "/jsp/basket.jsp";
    public static final String PATH_TO_MODRECIPE_JSP = "/jsp/modRecipes.jsp";
