...
public class JspParamName {
    ...
    public static final String PARAM_ERROR_LOGIN = "errorLoginPassMessage";
    public static final String PARAM_ERROR_REGISTRATION = "errorRegistrationMessage";
    public static final String PARAM_ERROR_DATABASE = "errorDataBase";
    public static final String PARAM_NAME = "name";
    public static final String PARAM_INTERN_NAME = "internName";
