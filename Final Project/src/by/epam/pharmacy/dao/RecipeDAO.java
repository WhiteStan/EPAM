...
public class RecipeDAO extends AbstractDAO {
    ...
    private final static String GET_ALL_REQUSTED_RECIPES = "SELECT idrecipe, patientLogin, amountOfDrug, drugName, isValid  FROM recipe WHERE isRequsted = 1";
    ...
    private final static String GET_RECIPE_BY_NAME = "SELECT drugName, amountOfDrug, term, idrecipe, isValid FROM recipe " +
            "WHERE patientLogin=?";
